...
ex-9-1-5 = T-Let (T-Abs (T-Abs (T-Abs (T-App (T-Var "f" (t (′ "b" ⇀ ′ "c")) refl raw)
                 ...
                 (T-Let (T-Abs (T-If (T-Var "x" (t bool) refl raw) T-Int T-Int)) -- f : int -> bool
                        (T-Let (T-Abs (T-Lt (T-Var "x" (t int) refl raw) T-Int)) -- g : bool -> int
                               (T-App (T-App (T-App (T-Var "compose" ("a" ◂ ("b" ◂ [ "c" ]) ̣ (′ "b" ⇀ ′ "c") ⇀ (′ "a" ⇀ ′ "b") ⇀ ′ "a" ⇀ ′ "c") refl (concretion (bool ◂ (bool ◂ [ int ]) , refl)))
                                                    (T-Var "f" ("b" ◂ [ "c" ] ̣ ′ "b" ⇀ ′ "c") refl (concretion ((bool ◂ [ int ]) , refl))))
                                             (T-App (T-App (T-Var "compose" ("a" ◂ ("b" ◂ [ "c" ]) ̣ (′ "b" ⇀ ′ "c") ⇀ (′ "a" ⇀ ′ "b") ⇀ ′ "a" ⇀ ′ "c") refl (concretion (bool ◂ (int ◂ [ bool ]) , refl)))
                                                           (T-Var "g" ("a" ◂ [ "b" ] ̣ ′ "a" ⇀ ′ "b") refl (concretion ((int ◂ [ bool ]) , refl))))
                                                    (T-Var "f" ("b" ◂ [ "c" ] ̣ ′ "b" ⇀ ′ "c") refl (concretion ((bool ◂ [ int ]) , refl)))))
                                      T-Bool)
----------------------------------------------
                               ({!!} , refl))
