                    ...
                    (E-App (E-App (E-Var refl)
                           ...
                           (E-Let (E-Assign (E-Var refl)
                                  ...
                                  (E-Deref (E-Var refl)
                                           refl))))
{-
|- let f = (fun r1 -> (fun r2 -> let z = (r2 := 3) in (! r1))) in let r = (ref 0) in f(r)(r) evalto 3 / @l = 3 by E-Let { |- (fun r1 -> (fun r2 -> let z = (r2 := 3) in (! r1))) evalto ()[fun r1 -> (fun r2 -> let z = (r2 := 3) in (! r1))] by E-Fun {};f = ()[fun r1 -> (fun r2 -> let z = (r2 := 3) in (! r1))] |- let r = (ref 0) in f(r)(r) evalto 3 / @l = 3 by E-Let {f = ()[fun r1 -> (fun r2 -> let z = (r2 := 3) in (! r1))] |- (ref 0) evalto @l / @l = 0 by E-Ref {f = ()[fun r1 -> (fun r2 -> let z = (r2 := 3) in (! r1))] |- 0 evalto 0 by E-Int {};};@l = 0 / f = ()[fun r1 -> (fun r2 -> let z = (r2 := 3) in (! r1))],r = @l |- f(r)(r) evalto 3 / @l = 3 by E-App {@l = 0 / f = ()[fun r1 -> (fun r2 -> let z = (r2 := 3) in (! r1))],r = @l |- f(r) evalto (r1 = @l)[fun r2 -> let z = (r2 := 3) in (! r1)] / @l = 0 by E-App {@l = 0 / f = ()[fun r1 -> (fun r2 -> let z = (r2 := 3) in (! r1))],r = @l |- f evalto ()[fun r1 -> (fun r2 -> let z = (r2 := 3) in (! r1))] / @l = 0 by E-Var {};@l = 0 / f = ()[fun r1 -> (fun r2 -> let z = (r2 := 3) in (! r1))],r = @l |- r evalto @l / @l = 0 by E-Var {};@l = 0 / r1 = @l |- (fun r2 -> let z = (r2 := 3) in (! r1)) evalto (r1 = @l)[fun r2 -> let z = (r2 := 3) in (! r1)] / @l = 0 by E-Fun {};};@l = 0 / f = ()[fun r1 -> (fun r2 -> let z = (r2 := 3) in (! r1))],r = @l |- r evalto @l / @l = 0 by E-Var {};@l = 0 / r1 = @l,r2 = @l |- let z = (r2 := 3) in (! r1) evalto 3 / @l = 3 by E-Let {@l = 0 / r1 = @l,r2 = @l |- (r2 := 3) evalto 3 / @l = 3 by E-Assign {@l = 0 / r1 = @l,r2 = @l |- r2 evalto @l / @l = 0 by E-Var {};@l = 0 / r1 = @l,r2 = @l |- 3 evalto 3 / @l = 0 by E-Int {};};@l = 3 / r1 = @l,r2 = @l,z = 3 |- (! r1) evalto 3 / @l = 3 by E-Deref {@l = 3 / r1 = @l,r2 = @l,z = 3 |- r1 evalto @l / @l = 3 by E-Var {};};};};};};
-}
                    ...
                    (E-Let (E-Ref {l = "@l3"} (E-Var refl) refl)
                           (E-Let (E-Ref {l = "@l4"} (E-Var refl) refl)
                                  (E-Let (E-Assign (E-Deref (E-Var refl) refl)
                                         ...
                                         (E-Deref (E-Var refl) refl)))))
{-
|- let x = (ref 2) in let y = (ref 3) in let refx = (ref x) in let refy = (ref y) in let z = ((! refx) := (! (! refy))) in (! x) evalto 3 / @l1 = 3,@l2 = 3,@l3 = @l1,@l4 = @l2 by E-Let { |- (ref 2) evalto @l1 / @l1 = 2 by E-Ref { |- 2 evalto 2 by E-Int {};};@l1 = 2 / x = @l1 |- let y = (ref 3) in let refx = (ref x) in let refy = (ref y) in let z = ((! refx) := (! (! refy))) in (! x) evalto 3 / @l1 = 3,@l2 = 3,@l3 = @l1,@l4 = @l2 by E-Let {@l1 = 2 / x = @l1 |- (ref 3) evalto @l2 / @l1 = 2,@l2 = 3 by E-Ref {@l1 = 2 / x = @l1 |- 3 evalto 3 / @l1 = 2 by E-Int {};};@l1 = 2,@l2 = 3 / x = @l1,y = @l2 |- let refx = (ref x) in let refy = (ref y) in let z = ((! refx) := (! (! refy))) in (! x) evalto 3 / @l1 = 3,@l2 = 3,@l3 = @l1,@l4 = @l2 by E-Let {@l1 = 2,@l2 = 3 / x = @l1,y = @l2 |- (ref x) evalto @l3 / @l1 = 2,@l2 = 3,@l3 = @l1 by E-Ref {@l1 = 2,@l2 = 3 / x = @l1,y = @l2 |- x evalto @l1 / @l1 = 2,@l2 = 3 by E-Var {};};@l1 = 2,@l2 = 3,@l3 = @l1 / x = @l1,y = @l2,refx = @l3 |- let refy = (ref y) in let z = ((! refx) := (! (! refy))) in (! x) evalto 3 / @l1 = 3,@l2 = 3,@l3 = @l1,@l4 = @l2 by E-Let {@l1 = 2,@l2 = 3,@l3 = @l1 / x = @l1,y = @l2,refx = @l3 |- (ref y) evalto @l4 / @l1 = 2,@l2 = 3,@l3 = @l1,@l4 = @l2 by E-Ref {@l1 = 2,@l2 = 3,@l3 = @l1 / x = @l1,y = @l2,refx = @l3 |- y evalto @l2 / @l1 = 2,@l2 = 3,@l3 = @l1 by E-Var {};};@l1 = 2,@l2 = 3,@l3 = @l1,@l4 = @l2 / x = @l1,y = @l2,refx = @l3,refy = @l4 |- let z = ((! refx) := (! (! refy))) in (! x) evalto 3 / @l1 = 3,@l2 = 3,@l3 = @l1,@l4 = @l2 by E-Let {@l1 = 2,@l2 = 3,@l3 = @l1,@l4 = @l2 / x = @l1,y = @l2,refx = @l3,refy = @l4 |- ((! refx) := (! (! refy))) evalto 3 / @l1 = 3,@l2 = 3,@l3 = @l1,@l4 = @l2 by E-Assign {@l1 = 2,@l2 = 3,@l3 = @l1,@l4 = @l2 / x = @l1,y = @l2,refx = @l3,refy = @l4 |- (! refx) evalto @l1 / @l1 = 2,@l2 = 3,@l3 = @l1,@l4 = @l2 by E-Deref {@l1 = 2,@l2 = 3,@l3 = @l1,@l4 = @l2 / x = @l1,y = @l2,refx = @l3,refy = @l4 |- refx evalto @l3 / @l1 = 2,@l2 = 3,@l3 = @l1,@l4 = @l2 by E-Var {};};@l1 = 2,@l2 = 3,@l3 = @l1,@l4 = @l2 / x = @l1,y = @l2,refx = @l3,refy = @l4 |- (! (! refy)) evalto 3 / @l1 = 2,@l2 = 3,@l3 = @l1,@l4 = @l2 by E-Deref {@l1 = 2,@l2 = 3,@l3 = @l1,@l4 = @l2 / x = @l1,y = @l2,refx = @l3,refy = @l4 |- (! refy) evalto @l2 / @l1 = 2,@l2 = 3,@l3 = @l1,@l4 = @l2 by E-Deref {@l1 = 2,@l2 = 3,@l3 = @l1,@l4 = @l2 / x = @l1,y = @l2,refx = @l3,refy = @l4 |- refy evalto @l4 / @l1 = 2,@l2 = 3,@l3 = @l1,@l4 = @l2 by E-Var {};};};};@l1 = 3,@l2 = 3,@l3 = @l1,@l4 = @l2 / x = @l1,y = @l2,refx = @l3,refy = @l4,z = 3 |- (! x) evalto 3 / @l1 = 3,@l2 = 3,@l3 = @l1,@l4 = @l2 by E-Deref {@l1 = 3,@l2 = 3,@l3 = @l1,@l4 = @l2 / x = @l1,y = @l2,refx = @l3,refy = @l4,z = 3 |- x evalto @l1 / @l1 = 3,@l2 = 3,@l3 = @l1,@l4 = @l2 by E-Var {};};};};};};};
-}
                           ...
                           (E-App (E-Var refl)
                                  ...
                                  (E-IfF (E-Lt (E-Var refl) E-Int (B-Lt refl))
                                         (E-Mult (E-Var refl)
                                                 ...
                                                 (B-Times refl))))))
{-
|- let f = (ref (fun x -> x)) in let fact = (fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))) in let z = (f := fact) in fact(3) evalto 6 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Let { |- (ref (fun x -> x)) evalto @l1 / @l1 = ()[fun x -> x] by E-Ref { |- (fun x -> x) evalto ()[fun x -> x] by E-Fun {};};@l1 = ()[fun x -> x] / f = @l1 |- let fact = (fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))) in let z = (f := fact) in fact(3) evalto 6 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Let {@l1 = ()[fun x -> x] / f = @l1 |- (fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))) evalto (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / @l1 = ()[fun x -> x] by E-Fun {};@l1 = ()[fun x -> x] / f = @l1,fact = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] |- let z = (f := fact) in fact(3) evalto 6 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Let {@l1 = ()[fun x -> x] / f = @l1,fact = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] |- (f := fact) evalto (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Assign {@l1 = ()[fun x -> x] / f = @l1,fact = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] |- f evalto @l1 / @l1 = ()[fun x -> x] by E-Var {};@l1 = ()[fun x -> x] / f = @l1,fact = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] |- fact evalto (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / @l1 = ()[fun x -> x] by E-Var {};};@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,fact = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))],z = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] |- fact(3) evalto 6 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-App {@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,fact = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))],z = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] |- fact evalto (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Var {};@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,fact = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))],z = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] |- 3 evalto 3 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Int {};@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 3 |- if (n < 1) then 1 else (n * (! f)((n - 1))) evalto 6 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-IfF {@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 3 |- (n < 1) evalto false / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Lt {@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 3 |- n evalto 3 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Var {};@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 3 |- 1 evalto 1 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Int {};3 less than 1 is false by B-Lt {};};@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 3 |- (n * (! f)((n - 1))) evalto 6 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Mult {@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 3 |- n evalto 3 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Var {};@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 3 |- (! f)((n - 1)) evalto 2 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-App {@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 3 |- (! f) evalto (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Deref {@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 3 |- f evalto @l1 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Var {};};@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 3 |- (n - 1) evalto 2 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Minus {@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 3 |- n evalto 3 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Var {};@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 3 |- 1 evalto 1 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Int {};3 minus 1 is 2 by B-Minus {};};@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 2 |- if (n < 1) then 1 else (n * (! f)((n - 1))) evalto 2 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-IfF {@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 2 |- (n < 1) evalto false / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Lt {@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 2 |- n evalto 2 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Var {};@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 2 |- 1 evalto 1 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Int {};2 less than 1 is false by B-Lt {};};@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 2 |- (n * (! f)((n - 1))) evalto 2 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Mult {@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 2 |- n evalto 2 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Var {};@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 2 |- (! f)((n - 1)) evalto 1 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-App {@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 2 |- (! f) evalto (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Deref {@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 2 |- f evalto @l1 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Var {};};@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 2 |- (n - 1) evalto 1 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Minus {@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 2 |- n evalto 2 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Var {};@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 2 |- 1 evalto 1 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Int {};2 minus 1 is 1 by B-Minus {};};@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 1 |- if (n < 1) then 1 else (n * (! f)((n - 1))) evalto 1 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-IfF {@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 1 |- (n < 1) evalto false / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Lt {@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 1 |- n evalto 1 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Var {};@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 1 |- 1 evalto 1 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Int {};1 less than 1 is false by B-Lt {};};@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 1 |- (n * (! f)((n - 1))) evalto 1 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Mult {@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 1 |- n evalto 1 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Var {};@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 1 |- (! f)((n - 1)) evalto 1 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-App {@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 1 |- (! f) evalto (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Deref {@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 1 |- f evalto @l1 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Var {};};@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 1 |- (n - 1) evalto 0 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Minus {@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 1 |- n evalto 1 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Var {};@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 1 |- 1 evalto 1 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Int {};1 minus 1 is 0 by B-Minus {};};@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 0 |- if (n < 1) then 1 else (n * (! f)((n - 1))) evalto 1 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-IfT {@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 0 |- (n < 1) evalto true / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Lt {@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 0 |- n evalto 0 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Var {};@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 0 |- 1 evalto 1 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Int {};0 less than 1 is true by B-Lt {};};@l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] / f = @l1,n = 0 |- 1 evalto 1 / @l1 = (f = @l1)[fun n -> if (n < 1) then 1 else (n * (! f)((n - 1)))] by E-Int {};};};1 times 1 is 1 by B-Mult {};};};};2 times 1 is 2 by B-Mult {};};};};3 times 2 is 6 by B-Mult {};};};};};};};
-}
