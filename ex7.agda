...
record ex7-2 : Set where
  ...
  open import BCoPL.Show.EvalML5
                                                                                           ...
                                                                                           (E-IfF (E-Lt (E-Var refl) (E-Var refl) (B-Lt refl))
                                                                                                  (E-AppRec (E-Var refl)
                                                                                                            ...
                                                                                                            (E-MatchM2 (E-Var refl)
                                                                                                                       ...
                                                                                                                       (E-Var refl)))))))))))
{-
|- let rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z))) in max((9 :: (2 :: (3 :: [])))) evalto 9 by E-LetRec {max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))] |- max((9 :: (2 :: (3 :: [])))) evalto 9 by E-AppRec {max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))] |- max evalto ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))] by E-Var {};max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))] |- (9 :: (2 :: (3 :: []))) evalto (9 :: (2 :: (3 :: []))) by E-Cons {max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))] |- 9 evalto 9 by E-Int {};max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))] |- (2 :: (3 :: [])) evalto (2 :: (3 :: [])) by E-Cons {max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))] |- 2 evalto 2 by E-Int {};max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))] |- (3 :: []) evalto (3 :: []) by E-Cons {max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))] |- 3 evalto 3 by E-Int {};max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))] |- [] evalto [] by E-Nil {};};};};max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))],l = (9 :: (2 :: (3 :: []))) |- (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z))) evalto 9 by E-MatchN {max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))],l = (9 :: (2 :: (3 :: []))) |- l evalto (9 :: (2 :: (3 :: []))) by E-Var {};(x::[]) doesn't match (9 :: (2 :: (3 :: []))) by NM-ConsConsR {[] doesn't match (2 :: (3 :: [])) by NM-ConsNil {};};max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))],l = (9 :: (2 :: (3 :: []))) |- (match l with (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z))) evalto 9 by E-MatchM1 {max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))],l = (9 :: (2 :: (3 :: []))) |- l evalto (9 :: (2 :: (3 :: []))) by E-Var {};(x::(y::z)) matches (9 :: (2 :: (3 :: []))) when (x = 9,y = 2,z = (3 :: [])) by M-Cons {x matches 9 when (x = 9) by M-Var {};(y::z) matches (2 :: (3 :: [])) when (y = 2,z = (3 :: [])) by M-Cons {y matches 2 when (y = 2) by M-Var {};z matches (3 :: []) when (z = (3 :: [])) by M-Var {};};};max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))],l = (9 :: (2 :: (3 :: []))),x = 9,y = 2,z = (3 :: []) |- if (x < y) then max((y :: z)) else max((x :: z)) evalto 9 by E-IfF {max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))],l = (9 :: (2 :: (3 :: []))),x = 9,y = 2,z = (3 :: []) |- (x < y) evalto false by E-Lt {max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))],l = (9 :: (2 :: (3 :: []))),x = 9,y = 2,z = (3 :: []) |- x evalto 9 by E-Var {};max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))],l = (9 :: (2 :: (3 :: []))),x = 9,y = 2,z = (3 :: []) |- y evalto 2 by E-Var {};9 less than 2 is false by B-Lt {};};max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))],l = (9 :: (2 :: (3 :: []))),x = 9,y = 2,z = (3 :: []) |- max((x :: z)) evalto 9 by E-AppRec {max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))],l = (9 :: (2 :: (3 :: []))),x = 9,y = 2,z = (3 :: []) |- max evalto ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))] by E-Var {};max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))],l = (9 :: (2 :: (3 :: []))),x = 9,y = 2,z = (3 :: []) |- (x :: z) evalto (9 :: (3 :: [])) by E-Cons {max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))],l = (9 :: (2 :: (3 :: []))),x = 9,y = 2,z = (3 :: []) |- x evalto 9 by E-Var {};max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))],l = (9 :: (2 :: (3 :: []))),x = 9,y = 2,z = (3 :: []) |- z evalto (3 :: []) by E-Var {};};max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))],l = (9 :: (3 :: [])) |- (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z))) evalto 9 by E-MatchN {max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))],l = (9 :: (3 :: [])) |- l evalto (9 :: (3 :: [])) by E-Var {};(x::[]) doesn't match (9 :: (3 :: [])) by NM-ConsConsR {[] doesn't match (3 :: []) by NM-ConsNil {};};max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))],l = (9 :: (3 :: [])) |- (match l with (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z))) evalto 9 by E-MatchM1 {max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))],l = (9 :: (3 :: [])) |- l evalto (9 :: (3 :: [])) by E-Var {};(x::(y::z)) matches (9 :: (3 :: [])) when (x = 9,y = 3,z = []) by M-Cons {x matches 9 when (x = 9) by M-Var {};(y::z) matches (3 :: []) when (y = 3,z = []) by M-Cons {y matches 3 when (y = 3) by M-Var {};z matches [] when (z = []) by M-Var {};};};max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))],l = (9 :: (3 :: [])),x = 9,y = 3,z = [] |- if (x < y) then max((y :: z)) else max((x :: z)) evalto 9 by E-IfF {max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))],l = (9 :: (3 :: [])),x = 9,y = 3,z = [] |- (x < y) evalto false by E-Lt {max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))],l = (9 :: (3 :: [])),x = 9,y = 3,z = [] |- x evalto 9 by E-Var {};max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))],l = (9 :: (3 :: [])),x = 9,y = 3,z = [] |- y evalto 3 by E-Var {};9 less than 3 is false by B-Lt {};};max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))],l = (9 :: (3 :: [])),x = 9,y = 3,z = [] |- max((x :: z)) evalto 9 by E-AppRec {max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))],l = (9 :: (3 :: [])),x = 9,y = 3,z = [] |- max evalto ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))] by E-Var {};max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))],l = (9 :: (3 :: [])),x = 9,y = 3,z = [] |- (x :: z) evalto (9 :: []) by E-Cons {max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))],l = (9 :: (3 :: [])),x = 9,y = 3,z = [] |- x evalto 9 by E-Var {};max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))],l = (9 :: (3 :: [])),x = 9,y = 3,z = [] |- z evalto [] by E-Var {};};max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))],l = (9 :: []) |- (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z))) evalto 9 by E-MatchM2 {max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))],l = (9 :: []) |- l evalto (9 :: []) by E-Var {};(x::[]) matches (9 :: []) when (x = 9) by M-Cons {x matches 9 when (x = 9) by M-Var {};[] matches [] when () by M-Nil {};};max = ()[rec max = fun l -> (match l with (x::[]) -> x | (x::(y::z)) -> if (x < y) then max((y :: z)) else max((x :: z)))],l = (9 :: []),x = 9 |- x evalto 9 by E-Var {};};};};};};};};};};};};
-}
  ...
  foo = {!!}
{-
|- let rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l'))) in heads(((1 :: (2 :: [])) :: ([] :: ((3 :: []) :: [])))) evalto (1 :: (3 :: [])) by E-LetRec {heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))] |- heads(((1 :: (2 :: [])) :: ([] :: ((3 :: []) :: [])))) evalto (1 :: (3 :: [])) by E-AppRec {heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))] |- heads evalto ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))] by E-Var {};heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))] |- ((1 :: (2 :: [])) :: ([] :: ((3 :: []) :: []))) evalto ((1 :: (2 :: [])) :: ([] :: ((3 :: []) :: []))) by E-Cons {heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))] |- (1 :: (2 :: [])) evalto (1 :: (2 :: [])) by E-Cons {heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))] |- 1 evalto 1 by E-Int {};heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))] |- (2 :: []) evalto (2 :: []) by E-Cons {heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))] |- 2 evalto 2 by E-Int {};heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))] |- [] evalto [] by E-Nil {};};};heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))] |- ([] :: ((3 :: []) :: [])) evalto ([] :: ((3 :: []) :: [])) by E-Cons {heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))] |- [] evalto [] by E-Nil {};heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))] |- ((3 :: []) :: []) evalto ((3 :: []) :: []) by E-Cons {heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))] |- (3 :: []) evalto (3 :: []) by E-Cons {heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))] |- 3 evalto 3 by E-Int {};heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))] |- [] evalto [] by E-Nil {};};heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))] |- [] evalto [] by E-Nil {};};};};heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = ((1 :: (2 :: [])) :: ([] :: ((3 :: []) :: []))) |- (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l'))) evalto (1 :: (3 :: [])) by E-MatchN {heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = ((1 :: (2 :: [])) :: ([] :: ((3 :: []) :: []))) |- l evalto ((1 :: (2 :: [])) :: ([] :: ((3 :: []) :: []))) by E-Var {};[] doesn't match ((1 :: (2 :: [])) :: ([] :: ((3 :: []) :: []))) by NM-ConsNil {};heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = ((1 :: (2 :: [])) :: ([] :: ((3 :: []) :: []))) |- (match l with ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l'))) evalto (1 :: (3 :: [])) by E-MatchN {heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = ((1 :: (2 :: [])) :: ([] :: ((3 :: []) :: []))) |- l evalto ((1 :: (2 :: [])) :: ([] :: ((3 :: []) :: []))) by E-Var {};([]::l') doesn't match ((1 :: (2 :: [])) :: ([] :: ((3 :: []) :: []))) by NM-ConsConsL {[] doesn't match (1 :: (2 :: [])) by NM-ConsNil {};};heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = ((1 :: (2 :: [])) :: ([] :: ((3 :: []) :: []))) |- (match l with ((x::_)::l') -> (x :: heads(l'))) evalto (1 :: (3 :: [])) by E-MatchM1 {heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = ((1 :: (2 :: [])) :: ([] :: ((3 :: []) :: []))) |- l evalto ((1 :: (2 :: [])) :: ([] :: ((3 :: []) :: []))) by E-Var {};((x::_)::l') matches ((1 :: (2 :: [])) :: ([] :: ((3 :: []) :: []))) when (x = 1,l' = ([] :: ((3 :: []) :: []))) by M-Cons {(x::_) matches (1 :: (2 :: [])) when (x = 1) by M-Cons {x matches 1 when (x = 1) by M-Var {};_ matches (2 :: []) when () by M-Wild {};};l' matches ([] :: ((3 :: []) :: [])) when (l' = ([] :: ((3 :: []) :: []))) by M-Var {};};heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = ((1 :: (2 :: [])) :: ([] :: ((3 :: []) :: []))),x = 1,l' = ([] :: ((3 :: []) :: [])) |- (x :: heads(l')) evalto (1 :: (3 :: [])) by E-Cons {heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = ((1 :: (2 :: [])) :: ([] :: ((3 :: []) :: []))),x = 1,l' = ([] :: ((3 :: []) :: [])) |- x evalto 1 by E-Var {};heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = ((1 :: (2 :: [])) :: ([] :: ((3 :: []) :: []))),x = 1,l' = ([] :: ((3 :: []) :: [])) |- heads(l') evalto (3 :: []) by E-AppRec {heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = ((1 :: (2 :: [])) :: ([] :: ((3 :: []) :: []))),x = 1,l' = ([] :: ((3 :: []) :: [])) |- heads evalto ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))] by E-Var {};heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = ((1 :: (2 :: [])) :: ([] :: ((3 :: []) :: []))),x = 1,l' = ([] :: ((3 :: []) :: [])) |- l' evalto ([] :: ((3 :: []) :: [])) by E-Var {};heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = ([] :: ((3 :: []) :: [])) |- (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l'))) evalto (3 :: []) by E-MatchN {heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = ([] :: ((3 :: []) :: [])) |- l evalto ([] :: ((3 :: []) :: [])) by E-Var {};[] doesn't match ([] :: ((3 :: []) :: [])) by NM-ConsNil {};heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = ([] :: ((3 :: []) :: [])) |- (match l with ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l'))) evalto (3 :: []) by E-MatchM2 {heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = ([] :: ((3 :: []) :: [])) |- l evalto ([] :: ((3 :: []) :: [])) by E-Var {};([]::l') matches ([] :: ((3 :: []) :: [])) when (l' = ((3 :: []) :: [])) by M-Cons {[] matches [] when () by M-Nil {};l' matches ((3 :: []) :: []) when (l' = ((3 :: []) :: [])) by M-Var {};};heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = ([] :: ((3 :: []) :: [])),l' = ((3 :: []) :: []) |- heads(l') evalto (3 :: []) by E-AppRec {heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = ([] :: ((3 :: []) :: [])),l' = ((3 :: []) :: []) |- heads evalto ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))] by E-Var {};heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = ([] :: ((3 :: []) :: [])),l' = ((3 :: []) :: []) |- l' evalto ((3 :: []) :: []) by E-Var {};heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = ((3 :: []) :: []) |- (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l'))) evalto (3 :: []) by E-MatchN {heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = ((3 :: []) :: []) |- l evalto ((3 :: []) :: []) by E-Var {};[] doesn't match ((3 :: []) :: []) by NM-ConsNil {};heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = ((3 :: []) :: []) |- (match l with ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l'))) evalto (3 :: []) by E-MatchN {heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = ((3 :: []) :: []) |- l evalto ((3 :: []) :: []) by E-Var {};([]::l') doesn't match ((3 :: []) :: []) by NM-ConsConsL {[] doesn't match (3 :: []) by NM-ConsNil {};};heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = ((3 :: []) :: []) |- (match l with ((x::_)::l') -> (x :: heads(l'))) evalto (3 :: []) by E-MatchM1 {heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = ((3 :: []) :: []) |- l evalto ((3 :: []) :: []) by E-Var {};((x::_)::l') matches ((3 :: []) :: []) when (x = 3,l' = []) by M-Cons {(x::_) matches (3 :: []) when (x = 3) by M-Cons {x matches 3 when (x = 3) by M-Var {};_ matches [] when () by M-Wild {};};l' matches [] when (l' = []) by M-Var {};};heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = ((3 :: []) :: []),x = 3,l' = [] |- (x :: heads(l')) evalto (3 :: []) by E-Cons {heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = ((3 :: []) :: []),x = 3,l' = [] |- x evalto 3 by E-Var {};heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = ((3 :: []) :: []),x = 3,l' = [] |- heads(l') evalto [] by E-AppRec {heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = ((3 :: []) :: []),x = 3,l' = [] |- heads evalto ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))] by E-Var {};heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = ((3 :: []) :: []),x = 3,l' = [] |- l' evalto [] by E-Var {};heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = [] |- (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l'))) evalto [] by E-MatchM2 {heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = [] |- l evalto [] by E-Var {};[] matches [] when () by M-Nil {};heads = ()[rec heads = fun l -> (match l with [] -> [] | ([]::l') -> heads(l') | ((x::_)::l') -> (x :: heads(l')))],l = [] |- [] evalto [] by E-Nil {};};};};};};};};};};};};};};};};};
-}
